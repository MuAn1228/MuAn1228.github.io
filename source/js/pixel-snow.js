// ===== 像素雪 PixelSnow（React Bits 移植为原生 JS，依赖 three.min.js r121）=====
// 仅 /fun/movies/ 生效
(function () {
  ...
  var colorV = new THREE.Color(PARAMS.color);
  var colorVec = new THREE.Vector3(colorV.r, colorV.g, colorV.b);
  ...
  var material = new THREE.ShaderMaterial({
    ...
    uniforms: {
      ...
      uMinFlakeSize: { value: PARAMS.minFlakeSize },
      uPixelResolution: { value: PARAMS.pixelResolution },
      uSpeed: { value: PARAMS.speed },
      uDepthFade: { value: PARAMS.depthFade },
      uFarPlane: { value: PARAMS.farPlane },
      uColor: { value: colorVec.clone() },
      uBrightness: { value: PARAMS.brightness },
      uGamma: { value: PARAMS.gamma },
      uDensity: { value: PARAMS.density },
      uVariant: { value: PARAMS.variant },
      uDirection: { value: (PARAMS.direction * Math.PI) / 180 }
    },
    transparent: true
  });
